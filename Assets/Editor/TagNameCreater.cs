...
public static class TagNameCreator
{
    ...
    private const string PATH = "Assets/_Script/Base/TagName.cs"; // ファイルパス
    ...
    private static readonly string FILENAME_WITHOUT_EXTENSION =
        Path.GetFileNameWithoutExtension(PATH); // ファイル名(拡張子なし)
    ...
    public static void CreateScript()
    {
        ...
        {
            builder.Append("\t")
                .AppendFormat(@"public const string {0} = ""{1}"";", n.var, n.val)
                .AppendLine();
        }
